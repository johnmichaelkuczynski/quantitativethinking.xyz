...
import { LayoutDashboard, PenTool, BarChart3, Activity, RotateCcw, ClipboardCheck } from "lucide-react";
      ...
      <div className="p-6 border-b border-border">
        <Link href="/">
          <div className="flex items-center gap-3 cursor-pointer">
            ...
            <span className="font-serif font-semibold text-lg tracking-tight">Quantitative Critical Reasoning</span>
          </div>
        </Link>
      </div>
